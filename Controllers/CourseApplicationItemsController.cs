...
namespace CourseApplication.Controllers
{
    ...
    [ApiController]
    public class CourseApplicationItemsController : ControllerBase
    {
        private readonly CourseApplicationContext _context;

        public CourseApplicationItemsController(CourseApplicationContext context)
        {
            _context = context;
        }

        // GET: api/CourseApplicationItems
        [HttpGet]
        ...
        // GET: api/CourseApplicationItems/5
        [HttpGet("{id}")]
        ...
        // PUT: api/CourseApplicationItems/5
        ...
        // POST: api/CourseApplicationItems
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<CourseApplicationItem>> PostCourseApplicationItem(CourseApplicationItem courseApplicationItem)
        {
            ...
            return CreatedAtAction(nameof(GetCourseApplicationItem), new { id = courseApplicationItem.Id }, courseApplicationItem);
        }

        // DELETE: api/CourseApplicationItems/5
        [HttpDelete("{id}")]
